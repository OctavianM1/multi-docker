...
docker push octavianmitu/multi-client:latest octavianmitu/multi-client:$SHA
docker push octavianmitu/multi-server:latest octavianmitu/multi-server:$SHA
docker push octavianmitu/multi-worker:latest octavianmitu/multi-worker:$SHA
kubectl apply -f k8s
